...
namespace CpuFeaturesDotNet.X86
{
    ...
    {
        [DllImport(LIBRARY, CallingConvention = CallingConvention.Cdecl, EntryPoint = "uarch")]
        public static extern MicroarchitectureX86 GetMicroarchitectureX86(LeafX86 leaf, int family, int model, int stepping);

        [DllImport(LIBRARY, CallingConvention = CallingConvention.Cdecl, EntryPoint = "xcr0_eax")]
